...
public class TestTable extends TableImpl<TestTableRecord> {
    ...
    /**
     * The reference instance of <code>testdb.test_table</code>
     */
    ...
    /**
     * The column <code>testdb.test_table.id</code>.
     */
    public final TableField<TestTableRecord, Integer> ID = createField(DSL.name("id"), SQLDataType.INTEGER.nullable(false).identity(true), this, "");

    /**
     * The column <code>testdb.test_table.name</code>.
     */
    public final TableField<TestTableRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR(45).nullable(false), this, "");

    /**
     * The column <code>testdb.test_table.age</code>.
     */
    public final TableField<TestTableRecord, Integer> AGE = createField(DSL.name("age"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>testdb.test_table.address</code>.
     */
    public final TableField<TestTableRecord, String> ADDRESS = createField(DSL.name("address"), SQLDataType.VARCHAR(45), this, "");
    ...
    /**
     * Create an aliased <code>testdb.test_table</code> table reference
     */
    ...
    /**
     * Create a <code>testdb.test_table</code> table reference
     */
    public TestTable() {
    ...
    public Identity<TestTableRecord, Integer> getIdentity() {
        return (Identity<TestTableRecord, Integer>) super.getIdentity();
    }
